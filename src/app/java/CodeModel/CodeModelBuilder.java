...
import org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTFieldImpl;
...
public class CodeModelBuilder extends CtAbstractVisitor {
    ...
    private boolean isTypeReferenceValid(CtTypeReference typeReference) {
        ...
        CtPackageReference elementPackage = typeReference.getTopLevelType().getPackage();
    ...
    private boolean isElementValid(CtElement element) {
        ...
        if (element instanceof CtFieldImpl) {
            isValid = !(element instanceof CtEnumValueImpl);
        }
    ...
    public <T> void visitCtNewClass(CtNewClass<T> newClass) {
        ...
        if (!outerClass.isEnum())  {
            ...
            if (innerClass.getReference() != null) {
    ...
    public <T> void visitCtFieldReference(CtFieldReference<T> fieldReference) {
        ...
        if(usingMethod != null && usedField instanceof CtFieldImpl && isElementValid(usedField)) {
